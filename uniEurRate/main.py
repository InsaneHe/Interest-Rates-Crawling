...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Euribor Data Viewer Application")
        ...
        # Title label
        self.title_label = QLabel("Showing  history rates data", self)
    ...
    def init_task_bar(self, layout):
        ...
        button_names = [("SEARCH", "scrape.png"), ("FOCUS", "view.png"), ("ABOUT", "about.png"), ("QUIT","quit.png")]  # Add more button names as needed
        for name, icon_filename in button_names:
            ...
            if name == "QUIT":
                ...
                button.clicked.connect(self.show_search_dialog)
            else:
    ...
    def init_home_page(self, layout):
        ...
        pixmap = QPixmap("img.png")  # Replace "your_image.png" with the filename of your PNG image
        home_image_label.setPixmap(pixmap)
        home_layout.addWidget(home_image_label , alignment=Qt.AlignCenter)

        home_text_label = QLabel("     \n\t ...  In particular, neither Erste Bank und Sparkassen nor any third party shall provide access to the Websites or offer \n\t"
                                 "the products displayed thereon to citizens/residents of the United States and 'U.S. persons' as defined in Regulation S \n\t"
                                 "under the U.S. Securities Act of 1933, as amended. Accordingly, any distribution or redistribution of the above-referenced\n\t"
                                 "information, materials and products in the United States or in any other jurisdiction where this is not permitted under applic\n\t"
                                 "-able law, as well as to the citizens/residents of these countries shall be prohibited. The securities referenced on the Web\n\t"
                                 "-sites have not been and will not be registered under the U.S. Securities Act of 1933, and trading in these \n\t"
                                 "securities has not been approved for the purposes of the U.S. Commodities Exchange Act of 1936. \n\t\t\n", self.home_page)
    ...
    def scrape_website(self):
        ...
        try:
            ...
            if response.status_code == 200:
                self.save_html_content(response.text)
            else:
